...
const visibleCompetitions = computed(() => normalizedCompetitions.value.slice(0, 5));
    ...
    <AuthenticatedLayout >
       <template #header>
            ...
            <p class="text-sm font-semibold text-white/75">
                Consulta de un vistazo las ligas y torneos guardados, su jornada actual y el tramo de temporada disponible.
            </p>
        </template>

        <div class="min-h-screen bg-[radial-gradient(circle_at_top,#f7f9fc_0%,#dce4ef_45%,#c7d3e6_100%)] px-4 py-5 lg:px-6 lg:py-6">
            <div class="mx-auto w-full max-w-[1500px]">
                <section class="rounded-[2rem] border-4 border-[#083b8d] bg-[#eef1f5] p-3 shadow-[0_18px_45px_rgba(8,59,141,0.18)] lg:p-4 mt-4">
                    <div class="rounded-[1.75rem] p-2 lg:p-3">
                        <div
                            v-if="visibleCompetitions.length"
