...
<template>
    <div>
        <div class="min-h-screen bg-slate-100 dark:bg-futbolix-navy">
            ...
            <!-- NAVBAR -->
            <nav class="border-b border-slate-700 bg-futbolix-dark sticky top-0 z-40" style="background-color: #00285E;">
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                ...
                                                <div
                                                    v-else
                                                    class="w-8 h-8 rounded-full bg-futbolix-green flex items-center justify-center text-sm font-bold text-white"
                                                >
                    ...
                    <div class="border-t border-slate-700 pb-1 pt-4">
                        <div class="px-4">
                            <div class="flex items-center gap-2">
                                <img v-if="authUser.avatar_url" :src="authUser.avatar_url" class="w-10 h-10 rounded-full object-cover" alt="avatar" />
                                <div v-else class="w-10 h-10 rounded-full bg-futbolix-green flex items-center justify-center font-bold text-white">
                                    {{ authUser.name?.charAt(0).toUpperCase() }}
                                </div>
                                <div>
                                    <div class="text-sm font-medium text-white">{{ authUser.name }}</div>
                                    <div class="text-xs text-slate-400">{{ authUser.email }}</div>
                                </div>
                            </div>
                        </div>
